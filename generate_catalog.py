...
def clean_display_title(filename: str, rel_path: str = "") -> str:
    ...
    title_overrides = {
        ...
        "Sedra_and_Smith_Microelectronic_Circuits_8th_International_Edition_Complete_Instructor_Solutions_Manual": "Microelectronic Circuits (8th Int. Ed) Complete Instructor's Solutions Manual — Sedra & Smith",
        "Behzad_Razavi_Design_of_Analog_CMOS_Integrated_Circuits_Complete_Solutions_Manual": "Design of Analog CMOS Integrated Circuits Complete Solutions Manual — Behzad Razavi",
        "The_Art_of_Electronics_3rd_Ed_Horowitz_Hill": "The Art of Electronics (3rd Ed) — Paul Horowitz & Winfield Hill",
        "Microelectronic_Circuit_Design_4th_Ed_Jaeger_Blalock": "Microelectronic Circuit Design (4th Ed) — Richard Jaeger & Travis Blalock",
        "Microelectronic_Circuits_5th_Ed_Sedra_Smith": "Microelectronic Circuits (5th Ed) — Adel Sedra & Kenneth Smith",
        "Designing_Audio_Power_Amplifiers_Bob_Cordell": "Designing Audio Power Amplifiers — Bob Cordell",
